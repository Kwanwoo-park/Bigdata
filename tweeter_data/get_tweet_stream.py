...
import urllib.request, datetime, time
from config import *
...
class TWoauth():
    ...
    def fetch(filter, jsonResult):
        ...
        url = "https://stream.twitter.com/2/statues/filter.json"
        parameters = []
        ...
        try:
            ...
            while True:
                ...
                if line:
                    try:
                        ...
                        print(tweet['text'])
                        TWoauth.getTwitterTwit(tweet, jsonResult)
            ...
            with open("%s_twitter.json" % (filter), 'w', encoding='utf8') as outfile:
                ret_json = json.dumps(jsonResult,
